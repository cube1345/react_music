...
const Footer: React.FC = () => {
  return (
    <FooterWrapper>
      ...
      <TextGroup>
        廉正举报 不良信息举报邮箱: <a href="mailto:51jubao@service.netease.com">51jubao@service.netease.com</a>
      </TextGroup>
      ...
      <TextGroup>
        网易公司版权所有©1997-2025 杭州乐读科技有限公司运营: 浙网文[2024] 0900-042号
        <span role="img" aria-label="police">🚓</span>浙公网安备 33010802013307号 算法服务公示信息
      </TextGroup>
    </FooterWrapper>
  );
};
